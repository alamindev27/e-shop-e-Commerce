...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="{{ asset('backend') }}/assets/plugins/datatable/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
        ...
        <style>
            ...
            .show-button i, .edit-button i, .delete-button i{
                color: #fff;
            }
            .edit-button{
                background: #3699FF;
...
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('vendor.create') }}" class="menu-link menu-toggle">
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('vendor.index') }}" class="menu-link menu-toggle">
                    ...
                    <span class="menu-text">Llist Vendor</span>
                </a>
            </li>
        </ul>
    </div>
        ...
        <ul class="menu-subnav">
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('category.index') }}" class="menu-link menu-toggle">
                    ...
                    <span class="menu-text">Llist Category</span>
                </a>
            </li>
        </ul>
    </div>
...
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('coupon.create') }}" class="menu-link menu-toggle">
                    <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                    </i>
                    <span class="menu-text">Add Coupon</span>
                </a>
            </li>
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('coupon.index') }}" class="menu-link menu-toggle">
                    <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                    </i>
                    <span class="menu-text">Llist Coupon</span>
                </a>
            </li>
        </ul>
    </div>
...
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('location.create') }}" class="menu-link menu-toggle">
                    <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                    </i>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('location.index') }}" class="menu-link menu-toggle">
                    <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                    </i>
                    <span class="menu-text">Llist Location</span>
                </a>
            </li>
        </ul>
    </div>
        ...
        <ul class="menu-subnav">
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ route('product.index') }}" class="menu-link menu-toggle">
                    ...
                    <span class="menu-text">Llist Product</span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="menu-submenu">
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				<h3 class="font-weight-bold m-0">@if (auth()->user()->role == 1)
                    Admin
                @endif
                @if (auth()->user()->role == 2)
                    Vendor
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('{{ asset('uploads/profile') }}/{{ auth()->user()->profile }}')"></div>
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<!--end:Item-->
					<!--begin::Item-->
					<a href="{{ route('setting.index') }}" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
