                ...
                <form action="{{ route('category.update', Crypt::encrypt($data->id)) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-danger">*</span></label>
                            <input type="file" class="form-control" name="category_image" onchange="document.getElementById('image_id').src = window.URL.createObjectURL(this.files[0])">
                            <span class="text-danger">
                        ...
                        <div class="form-group">
                            <img id="image_id" src="{{ asset('uploads/category_photo') }}/{{ $data->category_image }}" alt="{{ $data->category_image }}" style="width: 200px; margit:0 auto">
                        </div>
                        <!--end: Code-->
                    </div>
