						...
						<div class="login-form login-signin">
							...
							<form class="form" novalidate="novalidate" id="kt_login_signin_form" action="{{ route('login') }}" method="POST">
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text" name="email" autocomplete="off" placeholder="Enter your email" value="admin@gmail.com" />
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="password" name="password" autocomplete="off" placeholder="Enter your password" value="admin@gmail.com"/>
                                    <span class="text-danger">
                                        @error('password')
                                        {{$message}}
                                        @enderror
								...
								<div class="pb-lg-0 pb-5">
									<button class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" type="submit">Sign In</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
...
<form class="form" novalidate="novalidate" id="kt_login_signup_form" action="{{ route('register') }}" method="POST">
    ...
    <!--begin::Form group-->
    <div class="form-group">
        <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="text" placeholder="Enter name" name="name" autocomplete="off" />
        <span class="text-danger">
            @error('name')
            {{ $message }}
            @enderror
    ...
    <!--begin::Form group-->
    <div class="form-group">
        <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="email" placeholder="Enter email" name="email" autocomplete="off" />
        <span class="text-danger">
            @error('email')
            {{ $message }}
            @enderror
